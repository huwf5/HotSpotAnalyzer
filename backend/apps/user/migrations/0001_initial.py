    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(db_index=True, max_length=254, primary_key=True, serialize=False, unique=True, validators=[django.core.validators.EmailValidator()], verbose_name='email')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('format', models.CharField(max_length=255, primary_key=True, serialize=False, unique=True, validators=[apps.user.models.validate_format], verbose_name='email format')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('email', models.OneToOneField(db_column='email', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usage', models.CharField(choices=[('register', 'register'), ('reset_password', 'reset_password')], max_length=255, verbose_name="usage: ['register', 'reset_password']")),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('email_tag', models.CharField(max_length=255, verbose_name='email tag')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('warning', 'warning'), ('info', 'info')], max_length=255, verbose_name='message type')),
