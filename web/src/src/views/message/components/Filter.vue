<template>
  <div class="filter-container">
    <el-popover :visible="filterVisible" placement="bottom" trigger="contextmenu">
      <template #reference>
      ...
      <template #default>
        <div v-click-outside="handleClickOutside">
          <el-checkbox v-model="sysChecked" @change="displaySystemMessage" style="margin: 0px 10px">显示系统消息</el-checkbox>
          <el-checkbox v-model="readChecked" @change="displayReadMessage" style="margin: 0px 10px">显示已读消息</el-checkbox>
        </div>
      </template>
    </el-popover>
  </div>
